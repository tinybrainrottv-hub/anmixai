...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      className={cn(
        "group relative flex max-w-fit items-center justify-center gap-3 rounded-full border border-neutral-300 bg-white px-4 py-1.5 text-neutral-700 transition-colors dark:border-neutral-700/80 dark:bg-black dark:text-zinc-300",
        "whitespace-nowrap",
        className,
      )}
    >
      ...
      <span className="bg-clip-text text-xs font-medium whitespace-nowrap">{text}</span>
