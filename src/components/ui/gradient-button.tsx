...
export default function GradientButton({
  ...
  return (
    <Button
      className={cn(
        "group relative h-9 overflow-hidden rounded-lg px-4 transition-all duration-500",
    ...
    >
      <div
        className={cn(
          "absolute inset-0 rounded-lg bg-linear-to-b p-[1px]",
          "dark:bg-none",
          colors.light.border,
          colors.dark.border
        )}
      ...
      <div
        className={cn(
          "absolute inset-[1px] rounded-lg opacity-95",
          "bg-white/80",
          "dark:bg-[#0C1F21]"
        )}
      />
      ...
      <div
        className={cn(
          "absolute inset-[1px] rounded-lg bg-linear-to-r opacity-90",
          colors.light.base,
      ...
      <div
        className={cn(
          "absolute inset-[1px] rounded-lg bg-linear-to-b opacity-80",
      ...
      <div
        className={cn(
          "absolute inset-[1px] rounded-lg bg-linear-to-br",
          colors.light.accent,
          colors.dark.accent
        )}
      />
      ...
      <div className="relative flex items-center justify-center gap-2">
        <span
          className={cn(
            "bg-linear-to-b bg-clip-text font-light text-[13px] text-transparent tracking-tight",
            colors.light.text,
            colors.dark.text,
      ...
      <div
        className={cn(
          "absolute inset-[1px] rounded-lg bg-linear-to-r opacity-0 transition-opacity duration-300 group-hover:opacity-100",
          colors.light.hover,
          colors.dark.hover
        )}
      />
